...
Revision ID: 620f78bf7554
Revises: 
Create Date: 2024-10-14 00:32:08.024199
...
def upgrade() -> None:
    ...
    sa.Column('de_time', sa.Time(), nullable=True),
    sa.Column('bv_time', sa.Time(), nullable=True),
    sa.Column('sd_time', sa.Time(), nullable=True),
    ...
    sa.Column('model', sa.Enum('colony', 'user', 'player', 'cursedtechnique', 'ctapp', 'barriertech', 'match', 'vote', 'adminuser', 'permission', name='modelname'), nullable=False),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    ...
    sa.Column('points', sa.Numeric(scale=1), nullable=False),
    sa.Column('created', sa.Date(), nullable=False),
    sa.Column('ct_id', sa.Integer(), nullable=True),
